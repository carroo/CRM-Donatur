<div class="col-12">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h2 class="text-dark mb-0">Table Master Metode Pembayaran</h2>
            <div class="btn-group">
                        ...
                        <tr>
                            ...
                            <td class="">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <?php
                                    $linkhapus = base_url('master/metode_pembayaran_hapus/' . $value->id);
                                    ?>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('master/metode_pembayaran_tambah') ?>" method="post">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="type" class="form-label">Metode Pembayaran</label>
            ...
            <div class="modal fade" id="edit-<?= $value->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('master/metode_pembayaran_update/' . $value->id) ?>" method="post">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="type" class="form-label">Metode Pembayaran</label>
