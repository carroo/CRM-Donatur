<div class="col-12">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h2 class="text-dark mb-0">Table Master Kanal Donasi</h2>
            <div class="btn-group">
                        ...
                        <tr>
                            ...
                            <td class="">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <?php
                                    $linkhapus = base_url('master/kanal_donasi_hapus/' . $value->id);
                                    ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Kanal Donasi</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="<?= base_url('master/kanal_donasi_tambah') ?>" method="post">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="type" class="form-label">Kanal Donasi</label>
        ...
        <?php foreach ($data as $key => $value) : ?>
            <div class="modal fade" id="edit-<?= $value->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update Kanal Donasi</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="<?= base_url('master/kanal_donasi_update/' . $value->id) ?>" method="post">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="type" class="form-label">Kanal Donasi</label>
